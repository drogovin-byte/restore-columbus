...
export const services = [
  ...
  },
  {
    ...
    benefits: ["Deep detoxification", "Reduces muscle soreness", "Improves circulation", "Enhances relaxation"],
  ...
  },
  {
    ...
    benefits: ["Boosts cellular energy", "Reduces inflammation", "Improves skin health", "Enhances recovery"],
...
export const comparisons = [
  {
    ...
    image: "/images/service_07_Woman_wearing_protective_robe,.webp",
    fullContent: "## How Cryotherapy Works\n\nAt Restore Hyper Wellness, we offer **whole-body cryotherapy**—a cutting-edge recovery technology that exposes your body to extreme cold (-200°F to -300°F) for just **2-3 minutes**. This isn't your typical ice bath. Our cryotherapy chamber uses nitrogen vapor to rapidly cool your skin, triggering a cascade of physiological responses that accelerate recovery and reduce inflammation.\n\nWhen you step into our cryotherapy chamber, your body enters a state of controlled cold stress. Blood vessels constrict, pushing blood away from your extremities toward your core organs. Once you exit, vasodilation occurs—blood rushes back to your muscles, delivering oxygen and nutrients at an accelerated rate.\n\n## The Recovery Benefits\n\nThis process delivers powerful results:\n\n- **Reduces inflammation** by 30-50% compared to passive rest\n- **Decreases muscle soreness** (DOMS) significantly\n- **Speeds up recovery** dramatically between workouts\n- **Works fast** — benefits last 24-48 hours per session\n\n## Why Athletes Choose Cryotherapy\n\nAthletes love cryotherapy because it works **fast and efficient**. A single **3-minute session** can reduce inflammation and soreness for **24-48 hours**. You can do it between workouts, on rest days, or even before competition to reduce injury risk. The whole-body exposure means every muscle group benefits simultaneously.\n\n## Cold Plunges: The Alternative\n\n**Cold plunges** require you to immerse your entire body in ice-cold water (typically 50-60°F) for **5-15 minutes**. The experience is intense and takes discipline to maintain regularly.\n\n**Benefits you'll get:**\n- Reduced inflammation\n- Improved circulation\n- Enhanced recovery\n- Mental toughness building\n\nHowever, it takes longer and requires more mental toughness to maintain consistency.\n\n## The Key Difference: Intensity vs. Duration\n\n**Cryotherapy delivers extreme cold in minimal time**, making it perfect for busy athletes and professionals. You get results in just 3 minutes.\n\n**Cold plunges are more accessible for home use** but require consistency and tolerance for prolonged cold exposure (5-15 minutes).\n\n## Why Restore's Cryotherapy Wins\n\nAt Restore, our cryotherapy is administered by trained professionals in a controlled environment. You get the science-backed benefits without the hassle of maintaining an ice bath at home. Whether you're recovering from intense workouts, managing chronic inflammation, or optimizing athletic performance, our cryotherapy chamber delivers results fast."
  },
  {

...
export const ivMenu = {
  drips: [
    ...
    { id: "nad-iv-500", name: "NAD+ IV (500 mg)", category: "Cellular Rejuvenation", description: "Advanced cellular rejuvenation therapy that restores energy, supports longevity, and enhances mental clarity.", ingredients: ["NAD+"], memberPrice: 440, retailPrice: 550, sessionTime: "60-90 minutes" },
    { id: "nad-iv-750", name: "NAD+ IV (750 mg)", category: "Cellular Rejuvenation", description: "Advanced cellular rejuvenation therapy that restores energy, supports longevity, and enhances mental clarity.", ingredients: ["NAD+"], memberPrice: 530, retailPrice: 670, sessionTime: "60-90 minutes" },
    { id: "nad-iv-addon", name: "NAD+ IV (125 mg Add-On)", category: "Cellular Rejuvenation", description: "Add to any IV drip for enhanced cellular rejuvenation benefits.", ingredients: ["NAD+"], memberPrice: 110, retailPrice: 138, sessionTime: "Add-on" },
    { id: "nad-iv-im", name: "NAD+ IM Shot (125 mg)", category: "Cellular Rejuvenation", description: "Intramuscular NAD+ injection for rapid cellular rejuvenation.", ingredients: ["NAD+"], memberPrice: 115, retailPrice: 144, sessionTime: "IM Shot" },
    { id: "niagen-nr-500", name: "Niagen (NR) IV (500 mg)", category: "Cellular Regeneration", description: "Superior NAD+ precursor therapy with faster infusion and fewer side effects than traditional NAD+.", ingredients: ["Niagen (NR)"], memberPrice: 690, retailPrice: 860, sessionTime: "30-45 minutes" },
    { id: "niagen-nr-1000", name: "Niagen (NR) IV (1000 mg)", category: "Cellular Regeneration", description: "Superior NAD+ precursor therapy with faster infusion and fewer side effects than traditional NAD+.", ingredients: ["Niagen (NR)"], memberPrice: 1380, retailPrice: 1720, sessionTime: "30-45 minutes" },
    { id: "niagen-nr-addon", name: "Niagen (NR) IV (125 mg Add-On)", category: "Cellular Regeneration", description: "Add to any IV drip for enhanced cellular regeneration benefits.", ingredients: ["Niagen (NR)"], memberPrice: 173, retailPrice: 215, sessionTime: "Add-on" },
    { id: "niagen-nr-im", name: "Niagen (NR) IM Shot (125 mg)", category: "Cellular Regeneration", description: "Intramuscular Niagen (NR) injection for rapid cellular regeneration.", ingredients: ["Niagen (NR)"], memberPrice: 205, retailPrice: 245, sessionTime: "IM Shot" }
  ],
  nutrients: {
    signature: [
...
export const blogPosts = [
  ...
  {
    id: "valentines-day-wellness-columbus",
    slug: "valentines-day-wellness-columbus",
    title: "Beyond Dinner and Roses: Unique Valentine's Day Experiences in Columbus with Restore Hyper Wellness",
    excerpt: "Skip the crowded restaurants this Valentine's Day. Discover unique wellness experiences that nourish your relationship and leave you both feeling rejuvenated.",
    content: "Valentine's Day doesn't have to mean the same crowded restaurant and generic flowers. This year, give your partner something truly memorable—an experience that nourishes both body and soul. At Restore Hyper Wellness Columbus, we've curated the ultimate wellness-focused Valentine's experiences that go beyond traditional date night.\n\n## Why Wellness is the Perfect Valentine's Gift\n\nWhen you think about what makes a relationship thrive, it comes down to shared experiences, quality time, and genuine care for each other's wellbeing. Wellness dates check all three boxes. Unlike a one-time dinner reservation, a wellness experience creates lasting benefits for both of you—reduced stress, better sleep, improved mood, and more energy to enjoy life together. Plus, there's something deeply romantic about prioritizing your partner's health and happiness.\n\n## The Ultimate Columbus Valentine's Experiences\n\n### 1. The Couples' Recovery Escape: Cryotherapy + Red Light Therapy\n\nImagine stepping into a futuristic chamber together, experiencing the invigorating rush of cryotherapy at -200°C. It sounds intense—because it is—but it's also exhilarating and deeply bonding. Cryotherapy reduces inflammation, boosts mood, and increases energy levels. Follow it up with red light therapy, where you'll relax in a warm, glowing cocoon that stimulates collagen production and promotes skin healing.\n\n**Why it's romantic:** You're both experiencing something novel and slightly daring together. The endorphin rush creates natural euphoria, and you'll both leave glowing (literally) and energized for the rest of your day.\n\n**Perfect for:** Active couples who want to feel rejuvenated and look their best for each other.\n\n### 2. The Wellness Ritual: IV Drip + Infrared Sauna\n\nStart with a customized IV drip tailored to your wellness goals—whether it's the Myers Cocktail for immune support, the Hangover IV for detoxification, or the Unstoppable IV for energy and vitality. As the nutrients flow through your system, transition to our infrared sauna where you can relax together in a private, heated sanctuary.\n\nThe infrared sauna experience is deeply meditative. As your body detoxifies and your muscles relax, you'll have uninterrupted time to talk, laugh, and reconnect without the distractions of daily life. The sauna naturally boosts mood through endorphin release and improves circulation—leaving you both feeling revitalized and closer.\n\n**Why it's romantic:** It's intimate without being intrusive. You're both investing in your health while enjoying quality time together in a peaceful, luxurious setting.\n\n**Perfect for:** Couples seeking relaxation, detoxification, and a spa-like experience that actually delivers health benefits.\n\n### 3. The Glow-Up Date: HydraFacial + Skin Health Consultation\n\nBeauty is a form of self-care, and there's something special about getting pampered together. Our HydraFacial uses vortex-fusion technology to cleanse, extract, and hydrate your skin in just 30 minutes. Follow it with a personalized skin health consultation where our experts recommend treatments tailored to your unique needs.\n\nImagine leaving your appointment with glowing, hydrated skin and a clear roadmap for maintaining that glow. You'll both feel more confident and beautiful—and you'll have inside jokes about your newfound skincare routines.\n\n**Why it's romantic:** You're both investing in looking and feeling your best. There's something inherently romantic about self-care and the confidence that comes with it.\n\n**Perfect for:** Couples who love beauty, skincare, and want to feel polished and radiant together.\n\n### 4. The Energy Boost: IM Shots + Compression Therapy\n\nFor the couple that's always on the go, our IM (intramuscular) shot menu offers targeted wellness support. Choose from options like B-Complex for energy, Glutathione for anti-aging, or NAD+ for cellular rejuvenation. Pair this with compression therapy, which uses dynamic air compression to enhance circulation and accelerate recovery.\n\nYou'll both leave feeling energized, recovered, and ready to tackle whatever comes next—whether that's a night out dancing or a weekend adventure.\n\n**Why it's romantic:** You're both prioritizing vitality and longevity together. It's the ultimate statement: \"I want us both to feel amazing and live our best lives.\"\n\n**Perfect for:** Active couples, athletes, or anyone seeking a quick wellness boost before a big night out.\n\n### 5. The Holistic Healing Date: Biomarker Assessment + Personalized Wellness Plan\n\nFor the couple that wants to go deeper, our Biomarker Assessments provide comprehensive insights into your health—from hormone levels to metabolic markers. Spend time together learning about your bodies, understanding your wellness baselines, and creating a shared health journey.\n\nThis experience is about partnership and accountability. You'll both have personalized wellness plans, and you can support each other in achieving your health goals throughout the year.\n\n**Why it's romantic:** It's the ultimate commitment—investing in understanding and optimizing your health together. You're literally saying, \"I want us both to thrive.\"\n\n**Perfect for:** Couples seeking a deeper wellness journey and long-term health optimization.\n\n## Make It Extra Special: The Restore Valentine's Package\n\nCombine any two experiences above and enjoy quality time together in our peaceful lounge for the perfect Valentine's celebration. Our team can help you customize the perfect wellness date based on your goals and preferences.\n\n## The Real Romance\n\nAt the end of the day, the most romantic gift you can give your partner is time, attention, and genuine care for their wellbeing. A Valentine's date at Restore Hyper Wellness Columbus isn't just about the treatments—it's about showing your partner that you value their health, happiness, and the time you spend together.\n\nThis Valentine's Day, skip the crowded restaurants and generic gifts. Instead, create a memory that nourishes your relationship from the inside out.\n\n---\n\n## Ready to Plan Your Wellness Valentine's Date?\n\nOur team at Restore Hyper Wellness Columbus is here to help you design the perfect experience. Whether you're looking for relaxation, rejuvenation, or a complete wellness overhaul, we have something special for every couple.\n\n**Call us today to book your Valentine's experience:**\n- **Easton:** 614-944-9041\n- **Dublin:** 614-553-7207\n- **Upper Arlington:** 614-745-0966\n\nOr visit us online to explore all our services and create your perfect wellness date.\n\n*Restore Hyper Wellness Columbus—Where wellness meets romance.*\n",
    date: "2026-01-18",
    author: "Restore Team",
    category: "Wellness & Relationships",
    image: "/images/valentines-couples-wellness.jpg",
    tags: ["Valentine's Day", "Couples Wellness", "Romantic Experiences", "Columbus Date Ideas", "Recovery", "Wellness"]
  },
  {
    id: "winter-storm-recovery-columbus",
    slug: "winter-storm-recovery-columbus",
    title: "Winter Storm Recovery: How Restore Helps Columbus Bounce Back",
    excerpt: "Winter storms leave Columbus residents sore, stressed, and exhausted. Discover how Restore's science-backed therapies accelerate physical and mental recovery.",
    content: "Columbus winters can be brutal. When a major winter storm hits, residents face more than just snow and ice—they deal with the physical strain of shoveling, the stress of travel delays, the isolation of being stuck indoors, and the mental fatigue that comes with extended cold weather. The 2026 winter storms have left many Columbusians exhausted, sore, and emotionally drained. But recovery doesn't have to take weeks. At Restore Hyper Wellness, we have helped thousands of Columbus residents bounce back faster from winter's physical and mental challenges using science-backed therapies designed to accelerate healing and restore balance.\n\n## The Physical Toll of Winter Storms\n\nThe impact of winter weather on our bodies is more significant than most people realize. Shoveling snow puts intense strain on the back, shoulders, and legs—muscles that aren't always prepared for such explosive exertion. The cold itself causes muscles to tighten and blood vessels to constrict, reducing circulation and slowing the body's natural recovery processes. Many people wake up the morning after a major snowfall with muscle soreness, stiffness, and inflammation that can last for days or even weeks, making everyday activities painful and limiting mobility.\n\n### Cryotherapy: Reset Inflammation in Minutes\n\nCryotherapy reduces inflammation and accelerates muscle recovery by exposing your body to extreme cold for just three minutes. This triggers your body's natural healing response, reducing soreness and improving mobility. The cold exposure activates your parasympathetic nervous system, which is responsible for rest and recovery. Most people feel noticeably better within 24 hours of their first cryotherapy session.\n\n### Infrared Sauna: Deep Heat for Deep Relief\n\nInfrared Sauna therapy uses gentle heat to increase blood flow, relax muscles, and flush out toxins. Unlike traditional saunas that heat the air around you, infrared heat penetrates deep into tissue—reaching muscles and joints that regular saunas cannot. This deep penetrating warmth provides relief from winter-induced stiffness and pain while improving circulation to accelerate healing.\n\n### IV Drip Therapy: Replenish What Winter Takes\n\nIV Drip Therapy replenishes your body with essential vitamins, minerals, and hydration that stress and physical exertion deplete. Our Myers Cocktail and Immune Boost IV drips restore energy levels and support your body's natural recovery processes. When your body is recovering from physical trauma, it needs optimal nutrition—and IV therapy delivers it directly into your bloodstream for maximum absorption.\n\n## The Mental Impact of Winter Storms\n\nWinter storms don't just affect our bodies—they profoundly affect our minds. Being trapped indoors, dealing with travel stress, and enduring extended periods of cold and darkness can trigger anxiety, depression, and seasonal mood changes. Many Columbusians report feeling emotionally drained after major winter events, struggling with motivation and mental clarity.\n\n### Red Light Therapy: Cellular Energy for Mental Clarity\n\nRed Light Therapy has been shown to improve mood, reduce anxiety, and support mental clarity by stimulating cellular energy production. Just 20 minutes under our red light panels can help reset your mood and mental state. The therapy works at the mitochondrial level, boosting cellular energy production and supporting brain function.\n\n### Cryotherapy: The Endorphin Boost\n\nCryotherapy triggers the release of endorphins—your body's natural feel-good chemicals—providing an immediate mood boost and sense of mental clarity. The cold exposure activates your nervous system in a controlled way, creating a natural euphoria that can last for hours after treatment.\n\n### NAD+ IV Therapy: Restore Cognitive Function\n\nIV Drip Therapy with NAD+ supports cognitive function and mental energy by optimizing cellular metabolism. NAD+ is essential for brain health and energy production, making it ideal for combating winter fatigue and mental fog. Many people report improved focus, better sleep, and enhanced mental clarity after NAD+ therapy.\n\n### Infrared Sauna: The Meditative Reset\n\nInfrared Sauna provides a peaceful, meditative space to decompress. The warmth and relaxation activate your parasympathetic nervous system, reducing stress hormones and promoting mental calm. Thirty minutes in the sauna can reset your nervous system and provide relief from the accumulated stress of winter weather.\n\n## The Recovery Timeline: How Fast Can You Bounce Back?\n\nThe difference between struggling through winter recovery and actively accelerating it is significant. While most people take 1-2 weeks to fully recover from a major winter storm, Restore members often feel noticeably better within 24-48 hours of starting therapy. This isn't just anecdotal—it's the result of strategic, science-backed treatment protocols designed to address both physical and mental recovery.\n\n## Your Winter Recovery Protocol\n\nIf you are recovering from the recent Columbus winter storms, we recommend a targeted recovery approach based on your specific needs:\n\n**The 3-Day Recovery Plan** includes one cryotherapy session, one infrared sauna, and one IV drip therapy session over three days—perfect for acute soreness and stress relief. This intensive protocol is ideal if you're experiencing significant muscle soreness or mental fatigue.\n\n**The Weekly Reset** includes two cryotherapy sessions, two infrared saunas, and one IV drip therapy session per week—ideal for ongoing recovery and building resilience for future storms. This protocol helps you maintain momentum and prevent re-injury.\n\n**The Premium Recovery** adds NAD+ IV therapy to any plan for enhanced cellular recovery and mental energy restoration. This is perfect if you're dealing with significant fatigue or cognitive fog.\n\n## Don't Let Winter Slow You Down\n\nWhether you are dealing with muscle soreness, mental fatigue, or both, Restore has the science-backed therapies to help you recover faster and feel better. The key is taking action quickly—the sooner you start therapy, the faster your recovery.\n\n**Call us today to book your recovery session:**\n- **Easton:** 614-944-9041\n- **Dublin:** 614-553-7207\n- **Upper Arlington:** 614-745-0966\n\nRestore Hyper Wellness Columbus—Where Wellness Meets Recovery.",
    date: "2026-01-27",
    author: "Restore Team",
    category: "Seasonal Wellness",
    image: "/images/winter-storm-recovery-hero.jpg",
    tags: ["Winter Storm", "Recovery", "Physical Health", "Mental Health", "Columbus", "Wellness"]
  },
];
